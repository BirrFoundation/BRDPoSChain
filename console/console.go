...
import (
	...
	"BRDPoSChain/internal/jsre"
	"BRDPoSChain/internal/jsre/deps"
	"BRDPoSChain/internal/web3ext"
	"BRDPoSChain/rpc"
...
func (c *Console) Welcome() {
	// Print some generic BRC metadata
	fmt.Fprintf(c.printer, "Welcome to the BRC JavaScript console!\n\n")
	c.jsre.Run(`
