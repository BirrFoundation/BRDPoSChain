...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, BRCxState *tradingstate.TradingStateDB, header *types.Header, vmConfig *vm.Config) (*vm.EVM, func() error, error) {
	if vmConfig == nil {
	...
	return vm.NewEVM(context, txContext, state, BRCxState, b.eth.chainConfig, *vmConfig), state.Error, nil
}
...
func (b *LesApiBackend) BRCxService() *BRCx.BRCX {
	return nil
}

func (b *LesApiBackend) LendingService() *BRCxlending.Lending {
	return nil
}
