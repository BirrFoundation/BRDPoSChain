...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingBRC, &ping{From: testRemote, To: testLocalAnnounced, Version: Version})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingBRC, &ping{From: testRemote, To: testLocalAnnounced, Version: Version, Expiration: futureExp})
