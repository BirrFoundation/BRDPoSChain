...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case g != nil:
		...
		return g.Config
	case ghash == params.BRCMainnetGenesisHash:
		log.Info("[configOrDefault] load mainnetconfig")
		return params.BRCMainnetChainConfig
...
// DefaultGenesisBlock returns the BRC mainnet genesis block.
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.BRCMainnetChainConfig,
		Nonce:      0,
...
// DefaultTestnetGenesisBlock returns the BRC testnet genesis block.
...
// DefaultDevnetGenesisBlock returns the BRC devnet genesis block.
...
func DeveloperGenesisBlock(period uint64, faucet common.Address) *Genesis {
	...
	config := *params.AllBRDPoSProtocolChanges
	config.BRDPoS.Period = period
