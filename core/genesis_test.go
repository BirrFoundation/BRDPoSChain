...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.BRCMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.BRCMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.BRCMainnetGenesisHash,
			wantConfig: params.BRCMainnetChainConfig,
		},
		{
