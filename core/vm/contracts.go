...
import (
	...
	"BRDPoSChain/common"
	"BRDPoSChain/core/vm/privacy"
	"BRDPoSChain/crypto"
	"BRDPoSChain/crypto/blake2b"
	"BRDPoSChain/crypto/bn256"
	"BRDPoSChain/params"
...
var PrecompiledContractsByzantium = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{41}): &BRCxLastPrice{},
	common.BytesToAddress([]byte{42}): &BRCxEpochPrice{},
}
...
var PrecompiledContractsBRCv2 = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{1}): &ecrecover{},
	common.BytesToAddress([]byte{2}): &sha256hash{},
	common.BytesToAddress([]byte{3}): &ripemd160hash{},
	common.BytesToAddress([]byte{4}): &dataCopy{},
...
var (
	...
	PrecompiledAddressesBRCv2     []common.Address
...
func init() {
	...
	for k := range PrecompiledContractsBRCv2 {
		PrecompiledAddressesBRCv2 = append(PrecompiledAddressesBRCv2, k)
	}
...
func ActivePrecompiles(rules params.Rules) []common.Address {
	...
	case rules.IsBRCxDisable:
		return PrecompiledAddressesBRCv2
...
func RunPrecompiledContract(evm *EVM, p PrecompiledContract, input []byte, suppliedGas uint64) (ret []byte, remainingGas uint64, err error) {
	if evm != nil {
		if evm.chainConfig.IsTIPBRCXReceiver(evm.Context.BlockNumber) {
			switch p := p.(type) {
			case *BRCxEpochPrice:
