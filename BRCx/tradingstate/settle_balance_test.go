...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"BUY, quote is not BRC, makerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is not BRC, takerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is BRC, makerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseToken:         testToken,
				quoteToken:        common.BRCNativeAddressBinary,
				makerPrice:        common.BasePrice,
				makerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseTokenDecimal:  common.BasePrice,
				quoteTokenDecimal: common.BasePrice,
		...
		{
			"BUY, quote is BRC, takerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Taker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.BRCNativeAddressBinary, OutTotal: tradeQuantityIncludedFee},
				Maker: TradeResult{Fee: testFee, InToken: common.BRCNativeAddressBinary, InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
		...
		{
			"SELL, quote is not BRC, makerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is not BRC, takerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is BRC, makerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is BRC, takerFee <= 0.001 BRC",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Maker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.BRCNativeAddressBinary, OutTotal: tradeQuantityIncludedFee},
				Taker: TradeResult{Fee: testFee, InToken: common.BRCNativeAddressBinary, InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
	}
