...
import (
	_ "BRDPoSChain/crypto/secp256k1/libsecp256k1/include"
	_ "BRDPoSChain/crypto/secp256k1/libsecp256k1/src"
	_ "BRDPoSChain/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
