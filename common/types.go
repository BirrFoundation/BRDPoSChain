...
const (
	HashLength                       = 32
	AddressLength                    = 20
	BlockSigners                     = "brc0000000000000000000000000000000000000089"
	MasternodeVotingSMC              = "brc0000000000000000000000000000000000000088"
	RandomizeSMC                     = "brc0000000000000000000000000000000000000090"
	FoudationAddr                    = "brc0000000000000000000000000000000000000068"
	TeamAddr                         = "brc0000000000000000000000000000000000000099"
	BRCXAddr                         = "brc0000000000000000000000000000000000000091"
	TradingStateAddr                 = "brc0000000000000000000000000000000000000092"
	BRCXLendingAddress               = "brc0000000000000000000000000000000000000093"
	BRCXLendingFinalizedTradeAddress = "brc0000000000000000000000000000000000000094"
	BRCNativeAddress                 = "brc0000000000000000000000000000000000000001"
	LendingLockAddress               = "brc0000000000000000000000000000000000000011"
	VoteMethod                       = "0x6dd7d8ea"
	UnvoteMethod                     = "0x02aa9be2"
	ProposeMethod                    = "0x01267951"
	ResignMethod                     = "0xae6e43f5"
	SignMethod                       = "0xe341eaa4"
	BRCXApplyMethod                  = "0xc6b32f34"
	BRCZApplyMethod                  = "0xc6b32f34"
)
...
var (
	...
	BRCXAddrBinary                         = HexToAddress("0x0000000000000000000000000000000000000091")
	TradingStateAddrBinary                 = HexToAddress("0x0000000000000000000000000000000000000092")
	BRCXLendingAddressBinary               = HexToAddress("0x0000000000000000000000000000000000000093")
	BRCXLendingFinalizedTradeAddressBinary = HexToAddress("0x0000000000000000000000000000000000000094")
	BRCNativeAddressBinary                 = HexToAddress("0x0000000000000000000000000000000000000001")
...
func (a Address) Hex() string {
	...
	return "brc" + string(checksumed[2:])
}
...
func (a Address) MarshalText() ([]byte, error) {
	// Handle '0x' or 'brc' prefix here.
	if Enable0xPrefix {
		return hexutil.Bytes(a[:]).MarshalText()
	} else {
		return hexutil.Bytes(a[:]).MarshalBRCText()
	}
}
