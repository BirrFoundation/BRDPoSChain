...
var localConstant = constant{
	...
	tipBRCX:                       big.NewInt(0),
	tipBRCXLending:                big.NewInt(0),
	tipBRCXCancellationFee:        big.NewInt(0),
	tipBRCXCancellationFeeTestnet: big.NewInt(0),
	...
	tipBRCXMinerDisable:           big.NewInt(0),
	tipBRCXReceiverDisable:        big.NewInt(0),
