...
var MaintnetConstant = constant{
	...
	tipBRCX:                       big.NewInt(38383838),
	tipBRCXLending:                big.NewInt(38383838),
	tipBRCXCancellationFee:        big.NewInt(38383838),
	tipBRCXCancellationFeeTestnet: big.NewInt(38383838),
	...
	tipBRCXMinerDisable:           big.NewInt(80370000), // Target 2nd Oct 2024
	tipBRCXReceiverDisable:        big.NewInt(80370900), // Target 2nd Oct 2024, safer to release after disable miner
	...
	brcxListingSMC:        HexToAddress("0xDE34dD0f536170993E8CFF639DdFfCF1A85D3E53"),
	brcxListingSMCTestNet: HexToAddress("0x14B2Bf043b9c31827A472CE4F94294fE9a6277e0"),
