...
func TestIsHexAddress(t *testing.T) {
	tests := []struct {
		...
		{"brc5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"BRC5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"BrcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"brcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"brc5aaeb6053f3e94c9b9a09f33669435e7ef1beaed1", false},
		{"brc5aaeb6053f3e94c9b9a09f33669435e7ef1beae", false},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed11", false},
		{"brcxaaeb6053f3e94c9b9a09f33669435e7ef1beaed", false},
	}
...
func TestAddressUnmarshalJSON(t *testing.T) {
	var tests = []struct {
		...
		{`"brc"`, true, nil},
		{`"brc00"`, true, nil},
		{`"brcG000000000000000000000000000000000000000"`, true, nil},
		{`"brc0000000000000000000000000000000000000000"`, false, big.NewInt(0)},
		{`"brc0000000000000000000000000000000000000010"`, false, big.NewInt(16)},
	}
...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		{"brc5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", "brc5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed"},
		{"brcfb6916095ca1df60bb79ce92ce3ea74c37c5d359", "brcfB6916095ca1df60bB79Ce92cE3Ea74c37c5d359"},
		{"brcdbf03b407c01e7cd3cbea99509d93f8dddc8c6fb", "brcdbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB"},
		{"brcd1220a0cf47c7b9be7a2e6ba89f429762e7b9adb", "brcD1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb"},
		// Ensure that non-standard length input values are handled correctly
		{"0xa", "brc000000000000000000000000000000000000000A"},
		{"0x0a", "brc000000000000000000000000000000000000000A"},
		{"0x00a", "brc000000000000000000000000000000000000000A"},
		{"0x000000000000000000000000000000000000000a", "brc000000000000000000000000000000000000000A"},
	}
	for i, test := range tests {
...
func BenchmarkAddressHex(b *testing.B) {
	testAddr := HexToAddress("0brc5aaeb6053f3e94c9b9a09f33669435e7ef1beaed")
	for n := 0; n < b.N; n++ {
		testAddr.Hex()
	}
}
...
var testCases = []struct {
	...
	{BRCXAddrBinary, BRCXAddr},
	{TradingStateAddrBinary, TradingStateAddr},
	{BRCXLendingAddressBinary, BRCXLendingAddress},
	{BRCXLendingFinalizedTradeAddressBinary, BRCXLendingFinalizedTradeAddress},
	{BRCNativeAddressBinary, BRCNativeAddress},
