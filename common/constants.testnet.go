...
var TestnetConstant = constant{
	...
	tipBRCX:                       big.NewInt(23779191),
	tipBRCXLending:                big.NewInt(23779191),
	tipBRCXCancellationFee:        big.NewInt(23779191),
	tipBRCXCancellationFeeTestnet: big.NewInt(23779191),
	...
	tipBRCXMinerDisable:           big.NewInt(61290000), // Target 31st March 2024
	tipBRCXReceiverDisable:        big.NewInt(66825000), // Target 26 Aug 2024
