...
func TestRandomize(t *testing.T) {
	contractBackend := backends.NewBRCSimulatedBackend(types.GenesisAlloc{addr: {Balance: big.NewInt(100000000000000)}}, 10000000, params.TestBRDPoSMockChainConfig)
...
func TestSendTxRandomizeSecretAndOpening(t *testing.T) {
	...
	// TODO(daniel): replace NewSimulatedBackend with NewBRCSimulatedBackend
