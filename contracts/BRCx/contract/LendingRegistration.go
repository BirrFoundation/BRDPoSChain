...
// LAbstractBRCXListingABI is the input ABI used to generate the binding from.
const LAbstractBRCXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractBRCXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractBRCXListingBin = `0x`

// DeployLAbstractBRCXListing deploys a new Ethereum contract, binding an instance of LAbstractBRCXListing to it.
func DeployLAbstractBRCXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractBRCXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractBRCXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractBRCXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractBRCXListing{LAbstractBRCXListingCaller: LAbstractBRCXListingCaller{contract: contract}, LAbstractBRCXListingTransactor: LAbstractBRCXListingTransactor{contract: contract}, LAbstractBRCXListingFilterer: LAbstractBRCXListingFilterer{contract: contract}}, nil
}

// LAbstractBRCXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractBRCXListing struct {
	LAbstractBRCXListingCaller     // Read-only binding to the contract
	LAbstractBRCXListingTransactor // Write-only binding to the contract
	LAbstractBRCXListingFilterer   // Log filterer for contract events
}

// LAbstractBRCXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractBRCXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractBRCXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractBRCXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractBRCXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractBRCXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractBRCXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractBRCXListingSession struct {
	Contract     *LAbstractBRCXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts         // Call options to use throughout this session
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// LAbstractBRCXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractBRCXListingCallerSession struct {
	Contract *LAbstractBRCXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts               // Call options to use throughout this session
}

// LAbstractBRCXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractBRCXListingTransactorSession struct {
	Contract     *LAbstractBRCXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// LAbstractBRCXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractBRCXListingRaw struct {
	Contract *LAbstractBRCXListing // Generic contract binding to access the raw methods on
}

// LAbstractBRCXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractBRCXListingCallerRaw struct {
	Contract *LAbstractBRCXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractBRCXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractBRCXListingTransactorRaw struct {
	Contract *LAbstractBRCXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractBRCXListing creates a new instance of LAbstractBRCXListing, bound to a specific deployed contract.
func NewLAbstractBRCXListing(address common.Address, backend bind.ContractBackend) (*LAbstractBRCXListing, error) {
	contract, err := bindLAbstractBRCXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractBRCXListing{LAbstractBRCXListingCaller: LAbstractBRCXListingCaller{contract: contract}, LAbstractBRCXListingTransactor: LAbstractBRCXListingTransactor{contract: contract}, LAbstractBRCXListingFilterer: LAbstractBRCXListingFilterer{contract: contract}}, nil
}

// NewLAbstractBRCXListingCaller creates a new read-only instance of LAbstractBRCXListing, bound to a specific deployed contract.
func NewLAbstractBRCXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractBRCXListingCaller, error) {
	contract, err := bindLAbstractBRCXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractBRCXListingCaller{contract: contract}, nil
}

// NewLAbstractBRCXListingTransactor creates a new write-only instance of LAbstractBRCXListing, bound to a specific deployed contract.
func NewLAbstractBRCXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractBRCXListingTransactor, error) {
	contract, err := bindLAbstractBRCXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractBRCXListingTransactor{contract: contract}, nil
}

// NewLAbstractBRCXListingFilterer creates a new log filterer instance of LAbstractBRCXListing, bound to a specific deployed contract.
func NewLAbstractBRCXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractBRCXListingFilterer, error) {
	contract, err := bindLAbstractBRCXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractBRCXListingFilterer{contract: contract}, nil
}

// bindLAbstractBRCXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractBRCXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractBRCXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractBRCXListing *LAbstractBRCXListingRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _LAbstractBRCXListing.Contract.LAbstractBRCXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractBRCXListing *LAbstractBRCXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractBRCXListing.Contract.LAbstractBRCXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractBRCXListing *LAbstractBRCXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractBRCXListing.Contract.LAbstractBRCXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractBRCXListing *LAbstractBRCXListingCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _LAbstractBRCXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractBRCXListing *LAbstractBRCXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractBRCXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractBRCXListing *LAbstractBRCXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractBRCXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractBRCXListing *LAbstractBRCXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := &[]interface{}{
	...
	err := _LAbstractBRCXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractBRCXListing *LAbstractBRCXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractBRCXListing.Contract.GetTokenStatus(&_LAbstractBRCXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractBRCXListing *LAbstractBRCXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractBRCXListing.Contract.GetTokenStatus(&_LAbstractBRCXListing.CallOpts, arg0)
}
...
// BRCXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function BRCXListing() constant returns(address)
func (_Lending *LendingCaller) BRCXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := &[]interface{}{
	...
	err := _Lending.contract.Call(opts, out, "BRCXListing")
	return *ret0, err
}
...
//
// Solidity: function BRCXListing() constant returns(address)
func (_Lending *LendingSession) BRCXListing() (common.Address, error) {
	return _Lending.Contract.BRCXListing(&_Lending.CallOpts)
}

// BRCXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function BRCXListing() constant returns(address)
func (_Lending *LendingCallerSession) BRCXListing() (common.Address, error) {
	return _Lending.Contract.BRCXListing(&_Lending.CallOpts)
}
