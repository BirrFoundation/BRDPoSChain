...
# This script sets up a single BRDPoS validator node with proper genesis configuration
...
# Copy our manually created genesis file
...
echo "Checking validator logs (last 10 lines):"
tail -10 ./tmp/validator.log
