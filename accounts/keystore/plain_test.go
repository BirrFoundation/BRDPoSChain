...
func TestNewKeyForDirectICAP(t *testing.T) {
	...
	tests := []struct {
		...
		{"addr0 start with 0x00 or brc00", strings.HasPrefix(addr0.Hex(), "0x00") || strings.HasPrefix(addr0.Hex(), "brc00")},
		{"addr1 not start with 0x00 nor brc00", !strings.HasPrefix(addr1.Hex(), "0x00") && !strings.HasPrefix(addr1.Hex(), "brc00")},
	}
