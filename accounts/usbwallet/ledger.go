...
// ledgerDriver is a hardware wallet manager that communicates with Ledger
// hardware wallets.
type ledgerDriver struct {
	device  *hid.Device // USB device connection to communicate through
	browser bool        // Flag if the Ledger is in browser mode (reply channel mismatch)
...
func (w *ledgerDriver) Open(device *hid.Device, passphrase string) error {
