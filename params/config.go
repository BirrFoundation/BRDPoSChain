...
var (
	BRCMainnetGenesisHash = common.HexToHash("4a9d748bd78a8d0385b67788c2435dcdb914f98a96250b68863a1f8b7642d6b1") // BRC Mainnet genesis hash to enforce below configs on
...
var (
	...
	// BRDPoSChain mainnet config
	BRCMainnetChainConfig = &ChainConfig{
		...
		BRDPoS: &BRDPoSConfig{
			...
			Gap:                 450,
			FoudationWalletAddr: common.HexToAddress("brc92a289fe95a85c53b8d0d113cbaef0c1ec98ac65"),
			V2: &V2{
	...
	TestnetChainConfig = &ChainConfig{
		...
		BRDPoS: &BRDPoSConfig{
			...
			RewardCheckpoint:    900,
			Gap:                 450,
			FoudationWalletAddr: common.HexToAddress("brc746249c61f5832c5eed53172776b460491bdcd5c"),
			V2: &V2{
	...
	// AllBRDPoSProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Ethereum core developers into the BRDPoS consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllBRDPoSProtocolChanges = &ChainConfig{
		...
		Ethash:              nil,
		Clique:              nil,
		BRDPoS:              &BRDPoSConfig{Period: 0, Epoch: 900},
	}
	...
	// BRDPoS config with v2 engine after block 901
	TestBRDPoSMockChainConfig = &ChainConfig{
		ChainId:             big.NewInt(1337),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      false,
...
type ChainConfig struct {
	...
	BRDPoS *BRDPoSConfig `json:"BRDPoS,omitempty"`
}
...
// BRDPoSConfig is the consensus engine configs for delegated-proof-of-stake based sealing.
type BRDPoSConfig struct {
	Period              uint64         `json:"period"`              // Number of seconds between blocks to enforce
	Epoch               uint64         `json:"epoch"`               // Epoch length to reset votes and checkpoint
...
func (c *BRDPoSConfig) String() string {
	return "BRDPoS"
}

func (c *BRDPoSConfig) Description(indent int) string {
	if c == nil {
		return "BRDPoS: <nil>"
	}
...
func (c *BRDPoSConfig) BlockConsensusVersion(num *big.Int, extraByte []byte, extraCheck bool) string {
...
func (c *ChainConfig) IsPetersburg(num *big.Int) bool {
	return isForked(common.TIPBRCXCancellationFee, num) || isForked(c.PetersburgBlock, num)
}

// IsIstanbul returns whether num is either equal to the Istanbul fork block or greater.
func (c *ChainConfig) IsIstanbul(num *big.Int) bool {
	return isForked(common.TIPBRCXCancellationFee, num) || isForked(c.IstanbulBlock, num)
}
...
func (c *ChainConfig) IsTIPBRCX(num *big.Int) bool {
	return isForked(common.TIPBRCX, num)
}
func (c *ChainConfig) IsTIPBRCXMiner(num *big.Int) bool {
	return isForked(common.TIPBRCX, num) && !isForked(common.TIPBRCXMinerDisable, num)
}

func (c *ChainConfig) IsTIPBRCXReceiver(num *big.Int) bool {
	return isForked(common.TIPBRCX, num) && !isForked(common.TIPBRCXReceiverDisable, num)
}

func (c *ChainConfig) IsBRCxDisable(num *big.Int) bool {
	return isForked(common.TIPBRCXMinerDisable, num)
}

func (c *ChainConfig) IsTIPBRCXLending(num *big.Int) bool {
	return isForked(common.TIPBRCXLending, num)
}

func (c *ChainConfig) IsTIPBRCXCancellationFee(num *big.Int) bool {
	return isForked(common.TIPBRCXCancellationFee, num)
}
...
func (c *ChainConfig) Rules(num *big.Int) Rules {
	...
	return Rules{
		...
		IsBRCxDisable:    c.IsBRCxDisable(num),
