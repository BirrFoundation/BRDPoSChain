...
func (f *Forensics) ForensicsMonitoring(chain consensus.ChainReader, engine *BRDPoS_v2, headerQcToBeCommitted []types.Header, incomingQC types.QuorumCert) error {
...
*/
func (f *Forensics) ProcessForensics(chain consensus.ChainReader, engine *BRDPoS_v2, incomingQC types.QuorumCert) error {
	return nil
...
func (f *Forensics) SendForensicProof(chain consensus.ChainReader, engine *BRDPoS_v2, firstQc types.QuorumCert, secondQc types.QuorumCert) error {
...
*/
func (f *Forensics) ProcessVoteEquivocation(chain consensus.ChainReader, engine *BRDPoS_v2, incomingVote *types.Vote) error {
	return nil
