...
func (x *BRDPoS_v2) sendVote(chainReader consensus.ChainReader, blockInfo *types.BlockInfo) error {
...
func (x *BRDPoS_v2) verifyVotes(chain consensus.ChainReader, votes map[common.Hash]utils.PoolObj, header *types.Header) {
...
*/
func (x *BRDPoS_v2) onVotePoolThresholdReached(chain consensus.ChainReader, pooledVotes map[common.Hash]utils.PoolObj, currentVoteMsg utils.PoolObj, proposedBlockHeader *types.Header) error {
...
func (x *BRDPoS_v2) verifyVotingRule(blockChainReader consensus.ChainReader, blockInfo *types.BlockInfo, quorumCert *types.QuorumCert) (bool, error) {
	...
	*/
	...
	// BRDPoS v1.0 switch to v2.0, the proposed block can always pass voting rule
...
func (x *BRDPoS_v2) isExtendingFromAncestor(blockChainReader consensus.ChainReader, currentBlock *types.BlockInfo, ancestorBlock *types.BlockInfo) (bool, error) {
...
func (x *BRDPoS_v2) hygieneVotePool() {
	x.lock.RLock()
...
func (x *BRDPoS_v2) ReceivedVotes() map[string]map[common.Hash]utils.PoolObj {
