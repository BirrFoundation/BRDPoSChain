...
*/
func (x *BRDPoS_v1) SigHash(header *types.Header) (hash common.Hash) {
	return sigHash(header)
}

// New creates a BRDPoS delegated-proof-of-stake consensus engine with the initial
// signers set to the ones provided by the user.
func New(chainConfig *params.ChainConfig, db ethdb.Database) *BRDPoS_v1 {
...
func (x *BRDPoS_v1) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, x.signatures)
}

// VerifyHeader checks whether a header conforms to the consensus rules.
func (x *BRDPoS_v1) VerifyHeader(chain consensus.ChainReader, header *types.Header, fullVerify bool) error {
...
func (x *BRDPoS_v1) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, fullVerifies []bool, abort <-chan struct{}, results chan<- error) {
	go func() {
...
func (x *BRDPoS_v1) verifyHeaderWithCache(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *BRDPoS_v1) verifyHeader(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
	...
	// Ensure that the block doesn't contain any uncles which are meaningless in BRDPoS_v1
...
func (x *BRDPoS_v1) verifyCascadingFields(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *BRDPoS_v1) checkSignersOnCheckpoint(chain consensus.ChainReader, header *types.Header, signers []common.Address) error {
	number := header.Number.Uint64()
...
func (x *BRDPoS_v1) IsAuthorisedAddress(chain consensus.ChainReader, header *types.Header, address common.Address) bool {
...
func (x *BRDPoS_v1) GetSnapshot(chain consensus.ChainReader, header *types.Header) (*SnapshotV1, error) {
	number := header.Number.Uint64()
...
func (x *BRDPoS_v1) GetAuthorisedSignersFromSnapshot(chain consensus.ChainReader, header *types.Header) ([]common.Address, error) {
	snap, err := x.GetSnapshot(chain, header)
	if err != nil {
		return nil, err
	}
...
func (x *BRDPoS_v1) StoreSnapshot(snap *SnapshotV1) error {
	return snap.store(x.db)
}

func (x *BRDPoS_v1) GetMasternodes(chain consensus.ChainReader, header *types.Header) []common.Address {
...
func (x *BRDPoS_v1) GetCurrentEpochSwitchBlock(blockNumber *big.Int) (uint64, uint64, error) {
...
func (x *BRDPoS_v1) GetPeriod() uint64 { return x.config.Period }

func (x *BRDPoS_v1) whoIsCreator(snap *SnapshotV1, header *types.Header) (common.Address, error) {
...
func (x *BRDPoS_v1) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (bool, error) {
...
func (x *BRDPoS_v1) yourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (int, int, int, bool, error) {
...
func (x *BRDPoS_v1) snapshot(chain consensus.ChainReader, number uint64, hash common.Hash, parents []*types.Header, selfHeader *types.Header) (*SnapshotV1, error) {
...
func (x *BRDPoS_v1) VerifyUncles(chain consensus.ChainReader, block *types.Block) error {
...
func (x *BRDPoS_v1) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
...
func (x *BRDPoS_v1) verifySeal(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *BRDPoS_v1) GetValidator(creator common.Address, chain consensus.ChainReader, header *types.Header) (common.Address, error) {
...
func (x *BRDPoS_v1) Prepare(chain consensus.ChainReader, header *types.Header) error {
...
func (x *BRDPoS_v1) UpdateMasternodes(chain consensus.ChainReader, header *types.Header, ms []utils.Masternode) error {
...
func (x *BRDPoS_v1) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, parentState *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	// set block reward
	number := header.Number.Uint64()
	rCheckpoint := chain.Config().BRDPoS.RewardCheckpoint
...
// with.
func (x *BRDPoS_v1) Authorize(signer common.Address, signFn clique.SignerFn) {
	x.lock.Lock()
	defer x.lock.Unlock()
...
func (x *BRDPoS_v1) Seal(chain consensus.ChainReader, block *types.Block, stop <-chan struct{}) (*types.Block, error) {
	header := block.Header()
...
// current signer.
func (x *BRDPoS_v1) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
	x.lock.RLock()
	signer := x.signer
	x.lock.RUnlock()
...
func (x *BRDPoS_v1) calcDifficulty(chain consensus.ChainReader, parent *types.Header, signer common.Address) *big.Int {
...
func (x *BRDPoS_v1) RecoverSigner(header *types.Header) (common.Address, error) {
	return ecrecover(header, x.signatures)
}

func (x *BRDPoS_v1) RecoverValidator(header *types.Header) (common.Address, error) {
...
func (x *BRDPoS_v1) GetMasternodesFromCheckpointHeader(checkpointHeader *types.Header) []common.Address {
...
func (x *BRDPoS_v1) GetDb() ethdb.Database {
	return x.db
}
...
func (x *BRDPoS_v1) getSignersFromContract(chain consensus.ChainReader, checkpointHeader *types.Header) ([]common.Address, error) {
	startGapBlockHeader := checkpointHeader
	number := checkpointHeader.Number.Uint64()
	for step := uint64(1); step <= chain.Config().BRDPoS.Gap; step++ {
...
func NewFaker(db ethdb.Database, chainConfig *params.ChainConfig) *BRDPoS_v1 {
	var fakeEngine *BRDPoS_v1
	// Set any missing consensus parameters to their defaults
	conf := chainConfig.BRDPoS

	fakeEngine = &BRDPoS_v1{
		chainConfig: chainConfig,
...
func (x *BRDPoS_v1) IsEpochSwitch(header *types.Header) (bool, uint64, error) {
