...
func TestNotUpdateSignerListIfNotOnGapBlock(t *testing.T) {
	blockchain, backend, parentBlock, signer, signFn := PrepareBRCTestBlockChain(t, 400, params.TestBRDPoSMockChainConfig)
...
func TestNotChangeSingerListIfNothingProposedOrVoted(t *testing.T) {
	blockchain, _, parentBlock, signer, signFn := PrepareBRCTestBlockChain(t, GAP-1, params.TestBRDPoSMockChainConfig)
	// Insert block 450
...
func TestUpdateSignerListIfVotedBeforeGap(t *testing.T) {
	...
	blockchain, backend, parentBlock, signer, signFn := PrepareBRCTestBlockChain(t, GAP-2, params.TestBRDPoSMockChainConfig)
...
func TestCallUpdateM1WithSmartContractTranscation(t *testing.T) {
	...
	blockchain, backend, currentBlock, signer, signFn := PrepareBRCTestBlockChain(t, GAP-1, params.TestBRDPoSMockChainConfig)
...
func TestStatesShouldBeUpdatedWhenForkedBlockBecameMainChainAtGapBlock(t *testing.T) {
	...
	blockchain, backend, parentBlock, signer, signFn := PrepareBRCTestBlockChain(t, GAP-1, params.TestBRDPoSMockChainConfig)
